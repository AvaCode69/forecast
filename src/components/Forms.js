...
{name: 'Andorra', cities:[
  ...
  {name: 'Angola', cities:[
   ...
   {name: 'Antigua and Barbuda', cities:[
   "All Saints",
   "Cassada Gardens",
   "Codrington",
   "Old Road",
...
function Forms(props) {
    ...
    return (
      ...
      <select class="form-select form-select-lg mb-3" aria-label=".form-select-lg example" onChange={(e) => handleFromCountries(e)}  name="country">
      <option>Select country</option>
          {countryList.map((country, key) => (
            <option key={key} title={country.code}  >
              {country.name}
            </option>
          ))}
  </select>
